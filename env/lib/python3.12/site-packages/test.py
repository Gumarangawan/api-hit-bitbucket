...
def main():
    ...
    for commit in commits:
        ...
        commit_date = commit_date.astimezone(pytz.timezone('Asia/Jakarta'))  # Misalnya, ubah ke zona waktu Asia/Jakarta
        ...
        table.add_row([author_name, commit_id, commit_date.strftime("%Y-%m-%d %H:%M:%S"), loc_added, loc_removed, work_hours_estimation])
